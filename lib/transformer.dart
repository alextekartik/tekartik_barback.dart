library tekartik_transformer.transformer_common;
...
abstract class Transform {
  ...
  AssetId addOutputFromString(AssetId, String content, {Encoding encoding});

  /// The underlying aggregate transform.
  //final AggregateTransform _aggregate;
  //final dynamic _aggregate;
